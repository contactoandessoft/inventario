...
<div class="con-borde d-flex flex-column bg-white shadow-sm rounded" style="min-height: 100vh;">
    <h2 class="text-center mb-3 text-primary">Formulario de Edición de Equipo</h2>
    ...
    <div class="d-flex align-items-stretch flex-grow-1">
        <form method="POST" action="<?= base_url('editar/'.$equipo['id_formulario']); ?>" autocomplete="off" class="flex-grow-1 px-3 py-2" style="overflow-y: auto;" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="d-flex mb-2 flex-wrap">
                <div class="flex-grow-1 me-2 position-relative">
                    ...
                    <input type="text" id="numero_inventario" name="numero_inventario" class="form-control <?= isset($errors['numero_inventario']) ? 'is-invalid' : ''; ?>" value="<?= old('numero_inventario', $equipo['numero_inventario']) ?>" style="font-size: 0.9rem;">
                ...
                <div class="me-2" style="width: 150px;">
                    ...
                    <select id="estado" name="estado" class="form-control" style="font-size: 0.9rem;">
            ...
            <div class="d-flex mb-2 flex-wrap">
                <div class="flex-grow-1 me-2">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-control <?= isset($errors['descripcion']) ? 'is-invalid' : ''; ?>" rows="2" placeholder="Ingrese una descripción aquí..." style="font-size: 0.9rem;"><?= old('descripcion', $equipo['descripcion']) ?></textarea>
                ...
                <div style="width: 150px;">
                    ...
                    <select id="id_marcas" name="id_marcas" class="form-control <?= isset($errors['id_marcas']) ? 'is-invalid' : ''; ?>" style="font-size: 0.9rem;">
                        ...
                        <?php foreach ($marcas as $marca): ?>
                            <option value="<?= esc($marca['id_marcas']) ?>" <?= old('id_marcas', $equipo['id_marcas']) == $marca['id_marcas'] ? 'selected' : '' ?>><?= esc($marca['nombre_marca']) ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="d-flex mb-2">
                <div class="flex-grow-1 me-2">
                    ...
                    <input type="text" id="modelo" name="modelo" class="form-control <?= isset($errors['modelo']) ? 'is-invalid' : ''; ?>" value="<?= old('modelo', $equipo['modelo']) ?>" placeholder="Ingrese el modelo..." style="font-size: 0.9rem;">
            ...
            <div class="d-flex mb-2 flex-wrap">
                <div class="me-2" style="width: 150px;">
                    ...
                    <select id="id_tipo_equipo" name="id_tipo_equipo" class="form-control <?= isset($errors['id_tipo_equipo']) ? 'is-invalid' : ''; ?>" style="font-size: 0.9rem;">
                        ...
                        <?php foreach ($tipo_equipo as $tipo): ?>
                            <option value="<?= esc($tipo['id_tipo_equipo']) ?>" <?= old('id_tipo_equipo', $equipo['id_tipo_equipo']) == $tipo['id_tipo_equipo'] ? 'selected' : '' ?>><?= esc($tipo['nombre_tipo_equipo']) ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="me-2" style="width: 150px;">
                    ...
                    <input type="text" id="numero_serie" name="numero_serie" class="form-control" value="<?= old('numero_serie', $equipo['numero_serie']) ?>" placeholder="Número de serie" style="font-size: 0.9rem;">
                </div>

                <div style="width: 150px;">
                    <label for="ano_fabricacion" class="form-label">Año de Fabricación:</label>
                    <input type="number" id="ano_fabricacion" name="ano_fabricacion" class="form-control <?= isset($errors['ano_fabricacion']) ? 'is-invalid' : ''; ?>" value="<?= old('ano_fabricacion', $equipo['ano_fabricacion']) ?>" placeholder="Año" min="1900" style="font-size: 0.9rem;">
                ...
                <div style="width: 150px;">
                    ...
                    <input type="number" id="vida_util" name="vida_util" class="form-control <?= isset($errors['vida_util']) ? 'is-invalid' : ''; ?>" value="<?= old('vida_util', $equipo['vida_util']) ?>" placeholder="Vida útil" min="0" style="font-size: 0.9rem;">
            ...
            <div class="d-flex mb-2 flex-wrap">
                <div class="me-2" style="width: 150px;">
                    ...
                    <input type="date" id="fecha_alta" name="fecha_alta" class="form-control" value="<?= old('fecha_alta', $equipo['fecha_alta']) ?>" style="font-size: 0.9rem;">
                </div>

                <div style="width: 150px;">
                    <label for="valor_adquisicion" class="form-label">Valor de Adquisición:</label>
                    <input type="number" id="valor_adquisicion" name="valor_adquisicion" class="form-control <?= isset($errors['valor_adquisicion']) ? 'is-invalid' : ''; ?>" value="<?= old('valor_adquisicion', $equipo['valor_adquisicion']) ?>" placeholder="Valor en $" style="font-size: 0.9rem;">
            ...
            <div class="d-flex mb-2 flex-wrap">
                <div class="me-2" style="width: 150px;">
                    ...
                    <select id="id_responsable" name="id_responsable" class="form-control <?= isset($errors['id_responsable']) ? 'is-invalid' : ''; ?>" style="font-size: 0.9rem;">
                        ...
                        <?php foreach ($responsables as $responsable): ?>
                            <option value="<?= esc($responsable['id_responsable']) ?>" <?= old('id_responsable', $equipo['id_responsable']) == $responsable['id_responsable'] ? 'selected' : '' ?>><?= esc($responsable['nombre_responsable']) ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="me-2" style="width: 150px;">
                    ...
                    <input type="text" id="seccion" name="seccion" class="form-control" value="<?= old('seccion', $equipo['seccion']) ?>" placeholder="Nombre de la sección" style="font-size: 0.9rem;">
                </div>

                <div style="width: 150px;">
                    <label for="dependencia" class="form-label">Dependencia:</label>
                    <input type="text" id="dependencia" name="dependencia" class="form-control" value="<?= old('dependencia', $equipo['dependencia']) ?>" placeholder="Dependencia" style="font-size: 0.9rem;">
                </div>
            </div>

            <div class="mb-2">
                <label for="comentarios" class="form-label">Comentario:</label>
                <textarea id="comentarios" name="comentarios" class="form-control" rows="2" placeholder="Ingrese un comentario aquí..." style="font-size: 0.9rem;"><?= old('comentarios', $equipo['comentarios']) ?></textarea>
            </div>

            <div class="text-center mt-3 d-flex justify-content-center w-100">
                <button type="submit" class="btn btn-success btn-lg px-5 me-5" style="font-size: 0.9rem;">Actualizar</button>
        ...
        <div class="ms-3 text-center" style="flex-shrink: 0; width: 235px; position: relative;">
            <div class="position-relative" style="width: 100%; height: 200px;">
                <img id="imagen_equipo" 
                     src="<?= base_url('uploads/' . $equipo['numero_inventario'] . '.jpg') . '?' . time(); ?>" 
